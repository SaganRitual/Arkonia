...
class SensesConnector {
    ...
    private func connectGridInputs(
        ...
        func c() {
            ...
            let senseNeurons = UnsafeMutablePointer(mutating: scratch.stepper.net.neurons)
    ...
    private func connectNonGridInputs(_ dayFullness: CGFloat, _ yearFullness: CGFloat) {
        ...
        let mn = withUnsafeMutablePointer(to: &scratch.stepper.net.neurons[cGridSenseInputs]) { $0 }

        func setMiscSense(_ sense: MiscSenses, _ value: CGFloat) { mn[sense.rawValue] = Float(value) }
        ...
        let cMiscSenseInputs = MiscSenses.allCases.count
        let pollenatorsOffset = cGridSenseInputs + cMiscSenseInputs
        let pn = withUnsafeMutablePointer(to: &scratch.stepper.net.neurons[pollenatorsOffset]) { $0 }
