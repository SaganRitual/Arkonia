...
class Arkonia {
    ...
    static var debugMessageLevel = 121 // var so we can change it on the fly
    ...
    static let funkyCells: CGFloat? = 1.0
    static let initialPopulation = 10
    static let maxPopulation = 25
    ...
    static let mannaInitialRebloomDelay: TimeInterval = 5
    static let mannaRebloomDelayIncrement: TimeInterval = 5
