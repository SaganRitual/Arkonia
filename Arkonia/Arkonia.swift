...
class Arkonia {
    ...
    static var debugMessageLevel = 166 // var so we can change it on the fly
    ...
    static let arkonMinMoveDuration: TimeInterval = 0
    static let arkonMaxMoveDuration: TimeInterval = 0
